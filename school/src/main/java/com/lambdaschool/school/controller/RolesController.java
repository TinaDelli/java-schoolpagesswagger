...
public class RolesController
{
    ...
    public ResponseEntity<?> getRole(HttpServletRequest request, @PathVariable
            Long roleId)
    {
        logger.trace(request.getRequestURI() + " accessed");
    ...
    public ResponseEntity<?> addNewRole(HttpServletRequest request, @Valid @RequestBody
    ...
    public ResponseEntity<?> deleteRoleById(HttpServletRequest request, @PathVariable
            long id)
    {
        logger.trace(request.getRequestURI() + " accessed");
